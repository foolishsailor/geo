//tests
//const geo = require("../dist/index");

const geo = require("../dist/main.index.umd");
...
console.log(
  `Result: ${JSON.stringify(geo.getAvgOfBearings([330, 334, 350, 11, 12, 18]))}`
);
console.log(`Assert: {degrees: 354.91, radians: -0.07130099291306147}`);
console.log('GetAvg Bearing | ["qwe",365,11,12,-18]');
console.log(
  `Result: ${JSON.stringify(geo.getAvgOfBearings(["qwe", 365, 11, 12, -18]))}`
);
console.log(
  `Assert: {"error":"Invalid Bearings","values":[{"index":0,"value":"qwe"},{"index":1,"value":365},{"index":4,"value":-18}]}`
);
